...
export const Board: React.FC<PlaitBoardProps> = ({ style, className, children, afterInit }) => {
    ...
    return (
        <div
            ...
            style={style}
        >
            <div className="viewport-container" ref={viewportContainerRef} style={{ width: '100%', height: '100%', overflow: 'auto' }}>
                <svg ref={hostRef} width="100%" height="100%" style={{ position: 'relative' }} className="board-host-svg">
