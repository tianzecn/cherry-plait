...
export const LinkComponent = ({ attributes, children, element }: RenderElementPropsFor<LinkElement>) => {
    return (
        <a
            {...attributes}
            style={{
...
export const withInlineLink = (editor: CustomEditor) => {
    ...
    editor.isInline = (element: CustomElement) => {
        return ((element as LinkElement).type && ['link'].includes((element as LinkElement).type)) || isInline(element);
    };
